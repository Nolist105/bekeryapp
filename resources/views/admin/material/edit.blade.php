...
<div class="container-fluid px-4">
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('admin/updatematerial/'.$material->id) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{-- {{ method_field('put') }} --}}
                ...
                <div class="input-group mb-3">
                    ...
                    <input readonly type="text" name="M_ID" value="{{ $material->M_ID}}" class="form-control">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="M_name" value="{{ $material->M_name}}" class="form-control">
                </div>
...
{{--                     <input type="text" name="M_unit_pack" value="{{ $material->M_unit_pack}}" class="form-control">
...
{{--                     <input type="text" name="M_unit_use" value="{{ $material->M_unit_use}}" class="form-control">
 --}}                   <select class="form-select form-select" aria-label=".form-select example" name="M_unit_use">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" name="M_number" value="{{ $material->M_number}}" class="form-control">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ url('admin/material')  }}" class="btn btn-success">กลับ</a>
                </div>
